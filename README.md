...
**Option 1: Using BuildUI.bat (Recommended for beginners)**

1. Run BuildUI.bat (no admin privileges needed for configuration)
2. Use the menu to configure:
    * Source ISO path
    * Media extraction path
    * Output ISO path
    * Extra files path (optional)
    * Which build steps to include
3. Select [S] to save settings
4. Select [R] to run the build process with administrator privileges
